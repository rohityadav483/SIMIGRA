...
// Sidebar options
import { LayoutDashboard, Utensils, Theater, Briefcase } from 'lucide-react'

export const SidebarData = [
  { title: 'Dashboard', icon: <LayoutDashboard />, path: '/dashboard' },
  { title: 'Travel', icon: <Plane />, path: '/transport' },
  { title: 'Food', icon: <Utensils />, path: '/foodservices' },
  { title: 'Cultural', icon: <Theater />, path: '/cultural' },
  { title: 'Accommodation', icon: <Home />, path: '/accommodations' },
